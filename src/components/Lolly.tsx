...
export const Lolly: React.FC<Props> = ({LollyTop, LollyMiddle, LollyBottom}) => {
    return (
        <svg className="lollipop" width="163px" height="331px" viewBox="0 0 163 431" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Lolly">
                    ...
                    <use className="lollyBottom" fill={LollyBottom} fillRule="nonzero" href="#path-1"></use>
                    <rect className="lollyTop" fill={LollyTop} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9" width="224" height="134"></rect>
                    <rect className="lollyMiddle" fill={LollyMiddle} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113" width="224" height="111"></rect>
